...
#table["columns"] = ("name", "receipt", "item", "quantity")
#table.column("#0", width=0, stretch="NO")
#table.column("name", anchor="center", width=120)
#table.column("receipt", anchor="center", width=120)
#table.column("item", anchor="center", width=120)
#table.column("quantity", anchor="center", width=120)

#table.heading("#0", text="", anchor="w")
#table.heading("name", text="Name", anchor="center")
#table.heading("receipt", text="Receipt", anchor="center")
...
# table.insert ("", "item1", text = "First item")
table.pack()
